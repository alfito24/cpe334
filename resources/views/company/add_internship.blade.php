                ...
                <div class="max-w-4xl mx-auto bg-white p-6 rounded-lg shadow-md">
                    ...
                    <form method="POST" action="/add_internship">
                        ...
                        <div class="mb-4 flex justify-between space-x-4">
                            <div class="w-1/2">
                                <label class="block text-gray-700 text-sm font-semibold mb-2" for="location">Internship
                                    Location</label>
                            ...
                            <div class="w-1/2">
                                <label class="block text-gray-700 text-sm font-semibold mb-2"
                                    for="internship_type">Internship Type</label>
                        ...
                        <div class="mb-4 flex justify-between space-x-4">
                            <div class="w-1/2">
                                <label class="block text-gray-700 text-sm font-semibold mb-2" for="start_year">Stipend Range
                                    ($)</label>
                                <input id="start_year" type="number" min="0" name="salary"
                                    value="{{ old('salary') }}"
                                    class="border-2 border-[#0EA89B] appearance-none rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                                    type="text">
                                @error('salary')
                            ...
                            <div class="w-1/2">
                                <label class="block text-gray-700 text-sm font-semibold mb-2" for="stipend">No
                                    Stipend</label>
                                <input id="stipend" name="end_year" class="rounded py-2 px-3 text-gray-700"
                                    type="checkbox" onchange="toggleStipendRange()">
                            </div>
                        </div>
                        <div class="mb-4">
                        ...
                        <div class="mb-4">
                            ...
                            <input name="responsibilites" value="{{ old('responsibilites') }}"
                                class="border-2 border-[#0EA89B] appearance-none rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                                type="text" placeholder="">
                        ...
                        <div class="mb-4 flex justify-between space-x-4">
                            <div class="w-1/2">
                                <label class="block text-gray-700 text-sm font-semibold mb-2" for="location">Select
                                    Skills</label>
                                <select id="skillsDropdown" name="select_skills"
                                    class="mt-2 px-3 py-2 shadow rounded-lg w-full block text-sm border-2 border-[#0EA89B]">
                            ...
                            <div class="w-1/2">
                                <label class="block text-gray-700 text-sm font-semibold mb-2" for="internship_type">Skills
                                    Selected</label>
                                <input type="text" value="{{ old('skills') }}" name="skills" id="selectedSkills"
                                    class="border-2 border-[#0EA89B] appearance-none rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                        ...
                        <div class="mb-4">
                            ...
                            <input name="deadline" value="{{ old('deadline') }}"
                                class=" border-2 border-[#0EA89B] appearance-none rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                                type="date">
                            @error('deadline')
                                <div class="text-red-700">
                        ...
                        <div class="mb-4">
                            ...
                            <input name="start" value="{{ old('start') }}"
                                class=" border-2 border-[#0EA89B] appearance-none rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                                type="date">
                            @error('start')
                                <div class="text-red-700">
