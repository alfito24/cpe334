                ...
                <div class="">
                    ...
                    <div class="mb-4 mt-4">
                        ...
                        <div class="flex items-center">
                            <div
                                class="rounded-full h-14 w-14 flex items-center justify-center text-white text-2xl font-bold">
                    ...
                    <div class="grid grid-cols-2 gap-4 text-sm">
                        <div>
                            ...
                            <p class="flex items-center"><span class="mr-2">👥</span> {{ $company->company_size }}
                                employees</p>
                        </div>
                        <div>
