              ...
              <div class="mb-4">
                ...
                <div class="flex items-center">
                  <div class="w-12 h-12 rounded-full overflow-hidden mr-4">
                    ...
                    <img src="{{ url('/data_file/'.$user->picture) }}" alt="profile picture" class="w-full h-full object-cover" id="imagePreview">
                    @else
                    <img src="{{asset('images/it.png')}}" alt="profile picture" class="w-full h-full object-cover" id="imagePreview">
                    @endif
                  </div>
                  <div class="flex-grow">
                    <input type="file" name="picture" class="text-indigo-600 hover:text-indigo-900 text-sm mr-2" id="imageUpload" onchange="previewImage()" >
                  </div>
                </div>
              </div>
              <div class="mb-4">
                <label class="block text-gray-700 text-sm font-semibold mb-2" for="user_name">Full Name</label>
                <input name="name" class="border-2 border-[#0EA89B] appearance-none rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="user_name" type="text" value="{{ $user->name }}">
              </div>
              <div class="mb-4">
                <label class="block text-gray-700 text-sm font-semibold mb-2" for="skills">Professional Skills</label>
                ...
                <input name="skills" value="{{ $user->skills }}" class="border-2 border-[#0EA89B] appearance-none rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="selectedSkills" type="text" placeholder="Selected skills">
              </div>
              <div class="mb-6">
                <label class="block text-gray-700 text-sm font-semibold mb-2" for="description">Description</label>
                <textarea name="about_me" class="border-2 border-[#0EA89B] appearance-none rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="about_me">{{ $user->about_me }}</textarea>
              </div>
