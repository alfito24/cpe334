    ...
    <div class="container mx-auto p-6">
        ...
        <div class="grid md:grid-cols-2 gap-8">
            ...
            <div class="bg-white p-6 rounded-lg shadow-md">
                <h2 class="text-2xl mb-4 font-bold">Applying for {{ $intern->position }} at {{ $intern->user->company }}</h2>
                <!-- User info -->
                ...
                <div class="mb-4">
                    ...
                    <input value="{{ $user->address }}" type="text" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700" disabled/>
                </div>
                <!-- Resume Upload -->
                <div class="mb-4">
                    <label class="block text-gray-700 text-sm font-bold mb-2">Upload Resume</label>
                    <div class="flex items-center">
                        <input type="file" name="cv" class="shadow appearance-none border rounded py-2 px-3 text-gray-700" />
                    </div>
                </div>
                <!-- Cover Letter Upload -->
                <div class="mb-4">
                    <label class="block text-gray-700 text-sm font-bold mb-2">Upload Cover Letter</label>
                    <input type="file" name="cover_letter" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700"/>
                </div>
                <!-- Submit Button -->
                <button class="bg-[#0EA89B] hover:bg-green-700 text-white font-bold py-2 px-4 rounded w-full">Submit Application</button>
            </div>
            </form>
            @php
