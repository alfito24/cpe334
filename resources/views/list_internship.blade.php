    ...
    <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
      ...
      @foreach ($jobs as $job )
        <a href="/detail_internship/{{ $job->job_id }}">
          <div class="mb-4 p-4 bg-white border border-gray-200 rounded">
              <h4 class="font-bold text-purple-600">{{ $job->position }}</h4>
              <p>{{ $job->salary }}</p>
              <p>{{ $job->location }}</p>
      ...
      <div class="md:col-span-3">
        ...
        <div class="bg-white p-4 border border-gray-200 rounded">
          ...
          <!-- About Company -->
          {{-- <div>
            <h3 class="font-bold mb-2">About company</h3>
              ...
              <div class="px-4 py-5 sm:px-6 flex justify-between items-center">
                <div class="flex items-center">
                  ...
                  <div class="ml-4">
                    ...
                    <p class="mt-1 max-w-2xl text-sm text-gray-500" style="text-align: jus">{{ $job->user->company_description }}</p>
                  </div>
                </div>
