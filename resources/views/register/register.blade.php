...
<head>
    ...
    <title>Student/Applicant Register</title>
                ...
                <form action="/registerStudent" method="POST">
                    ...
                    <div class="mt-5">
                        <label for="birthdate"><span class="font-semibold text-md">Birth Date</span>
                            <input name='birth_date' type="date" placeholder="Select your birth date"
                    ...
                    <div class="mt-5">
                        <label for="about_me"><span class="font-semibold text-md">About Me</span>
                            <input name='about_me' type="text" placeholder="Write the description of yourself"
                                value="{{ old('about_me') }}"
                                class="mt-2 px-3 py-2 shadow rounded-lg w-full block text-sm border-2 border-[#0EA89B]">
                        </label>
                        @error('about_me')
                    ...
                    <div class="mt-5">
                        <label for="job_dream"><span class="font-semibold text-md">Job Dream</span>
                            <input name='job_dream' type="text" placeholder="Write the description of yourself"
                                value="{{ old('job_dream') }}"
                                class="mt-2 px-3 py-2 shadow rounded-lg w-full block text-sm border-2 border-[#0EA89B]">
                        </label>
                        @error('job_dream')
                    ...
                    <div class="mt-5">
                        <input type="text" id="selectedSkills" value="{{ old('skills') }}" name="skills"
                            class="block p-2.5 w-full z-20 text-sm text-gray-900 rounded-lg border-[#0EA89B] border-2"
                            placeholder="Selected Area of Expertise" readonly>
                    </div>
                    ...
                    <button
                        class="mt-8 text-lg font-semibold bg-[#0EA89B] w-full text-white rounded-xl px-6 py-3 block  hover:text-black hover:bg-[#FFFFFF]"
                        style="box-shadow: 2px 10px 20px rgba(0, 0, 0, 0.25);">
                        Sign Up
                    </button>
                </form>
                <p class="pt-7 text-md text-[#0EA89B] text-center"> Already have an account? <a href="/login"
                        class="text-[#0EA89B] font-semibold" style="color: #0EA89B"> Login here </a></p>
            </div>
        </div>
    </div>
