...
@section('content')
    <div class="bg-[#ECFDFC] py-7 md:py-9 grid grid-cols-1 gap-x-10 gap-y-12 font-poppins sm:grid-cols-2 md:mt-16">
        ...
        <div
            class="order-2 sm:order-1 px-24 sm:px-5 md:px-7 lg:px-32 flex flex-col items-center justify-center md:items-start ">
            ...
            <a href="/list_internship"
                class="mt-5 sm:mt-7 py-2 min-w-[50%] sm:min-w-[65%] lg:min-w-[50%] bg-[#0EA89B] text-xl font-bold text-white rounded hover:from-[#BFD9EB] hover:text-cyan-400 transition duration-300 block text-center">Explore
                Now</a>
        ...
        <div class="w-1/2 mx-auto  md:w-1/2 bg-white shadow-md rounded-lg p-4 flex items-center">
            <form action="/internship/search" method="get" class="w-full flex items-center">
                <input type="text" name="search" id="search"
                    class="w-full p-2 rounded-lg border-2 border-[#0EA89B] focus:outline-none"
                    placeholder="Search internships...">
                <button type="submit"
                    class="ml-4 px-4 py-2 bg-[#0EA89B] text-white rounded-lg hover:bg-[#FFFFFF] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 hover:from-[#BFD9EB] hover:text-[#0EA89B] transition duration-300">
                    Search
                </button>
            </form>
        </div>
