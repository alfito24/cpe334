    ...
    <div class="container mx-auto font-poppins max-w-sm m-9 bg-[#FBFCFF]  lg:max-w-4xl">
        <div class="rounded-lg flex shadow-full lg:rounded-none lg:rounded-r-lg">
            <div class="hidden bg-[#0EA89B] lg:inline lg:flex-1 lg:rounded-l-lg">
                <h1 class="font-bold text-center text-white mt-1 lg:text-2xl lg:py-16">We help you to <br> apply your
                    internship</h1>
            ...
            <div class="px-7 py-6 lg:px-8 lg:flex-1">
                ...
                <form action="/login" method="POST">
                        ...
                        <label for="password"><span class="font-semibold text-md">Password</span>
                            <div class="relative">
                                <input placeholder="Enter your password" :type="show ? 'password' : 'text'"
                                    class="mt-2 px-3 py-2 shadow rounded-lg w-full  text-sm border-2 border-[#0EA89B] "
                                    name="password">
                    ...
                    <button
                        class="mt-3 text-lg font-semibold bg-[#0EA89B] w-full text-white rounded-xl px-6 py-3 block  hover:text-black hover:bg-[#0EA89B]"
                        style="box-shadow: 2px 10px 20px rgba(0, 0, 0, 0.25);">
                        Login
                    </button>
                </form>
                <p class="pt-7 text-md text-[#B5B3BC] text-center"> Don’t have an account? <a href="/chooserole"
                        class="text-[#0EA89B] font-semibold" style="color: #0EA89B"> Sign up here </a></p>
            </div>
        </div>
    </div>
