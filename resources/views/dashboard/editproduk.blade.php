                        ...
                        <div class="card card-primary">
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <img src="{{ url('/data_file/'.$products->gambar) }}" alt="" class="img-preview" style="width: 400px;height:400px">
                                    <input class="form-control" name="file" type="file" id="image" onchange="previewImage()">
                                </div>
                                <div class="form-group">
                                    <label for="inputName">Nama Produk</label>
                                    <input type="text" name="nama_produk" class="form-control" value="{{ $products->judul }}">
                                </div>
                                <div class="form-group">
                                    <label for="inputName">Deskripsi Produk</label>
                                    <input type="text" name="deskripsi_produk" class="form-control" value="{{ $products->deskripsi }}">
                                </div>
                                <div class="form-group">
                                    <label for="inputName">Stock Produk</label>
                                    <input type="number" name="stock_produk" placeholder="" class="form-control" value="{{ $products->stock }}">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="shipping_point" placeholder="" class="form-control" value="{{ $products->shipping_point }}">
                                </div>
                                <div class="form-group">
                                    <label for="inputStatus">Bahan</label>
                                    <select id="inputStatus" name="bahan_produk" class="form-control custom-select">
                                        <option selected disabled>Select one</option>
                                        <option {{ $products->bahan_produk === 'Plastic' ? 'selected' : '' }} value="Plastic">Plastic</option>
                                        <option {{ $products->bahan_produk === 'Paper' ? 'selected' : '' }} value="Paper">Paper</option>
                                        <option {{ $products->bahan_produk === 'Metals' ? 'selected' : '' }} value="Metals">Metals</option>
                                        <option {{ $products->bahan_produk === 'Glass' ? 'selected' : '' }} value="Glass">Glass</option>
                                    </select>
                                </div>
                            </div>
                        </div>
